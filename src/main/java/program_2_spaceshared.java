...
public class program_2_spaceshared {
    ...
    private static Logger log = LoggerFactory.getLogger(program_2_spaceshared.class);
    ...
    static  void printCloudletList(List<CustomCloudlet> list){
        ...
        if (cloudlet.getStatus() == Cloudlet.Status.SUCCESS) {
            ...
            if (cloudlet.getType()== CustomCloudlet.Type.REDUCER) {
                log.info(mod + cloudlet.getId() + mod + mod + "  SUCCESS" + mod + mod + mod + mod +
                        ...
                        decimalFormat.format(cloudlet.getActualCpuTime()) + mod + mod +
                        decimalFormat.format(cloudlet.getExecStartTime()) + mod + mod + mod +
                        decimalFormat.format(cloudlet.getFinishTime()) + mod + mod + mod + mod +
