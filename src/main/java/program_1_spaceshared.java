...
public class program_1_spaceshared {
    ...
    public static void main(String[] args) throws Exception {
        ...
        briteNetworkTopology.addLink(datacenters.get(0).getId(),brokerPolicy.getId(),1000,70000);
        briteNetworkTopology.addLink(datacenters.get(1).getId(),brokerPolicy.getId(),1000,70000);
    ...
    //prints the summary of simulation
